...
## -*- texinfo -*-
## @deftypefn {} {@var{outstr} =} __publish_nbformat_output__ (@var{type}, @var{varargin})
##
## Internal function.
##
...
function outstr = __publish_nbformat_output__ (type, varargin)
...
'  {',
'  "cell_type" : "code",',
'  "execution_count": null, # integer or null',
'  "metadata" : {},',
'  "source" : "', str, '",',
'  "outputs": [{',
